...
stm_ep();
stm_aix("p1i7","p1i2",[0,"  File Suplie Obat  "]);
stm_bpx("p8","p2",[]);
...
stm_aix("p9i1","p1i0",[0,"  Daftar Pasien Rawat Jalan / Inap  ","","",-1,-1,0,"daftar/daftarrawatpasien.asp"]);
stm_aix("p9i2","p1i0",[0,"  Daftar Pasien Mondok","","",-1,-1,0,"daftar/daftarpasienmondok.asp"]);
stm_aix("p9i3","p1i2",[0,"  Obat"]);
stm_bpx("p10","p1",[1,2]);
...
stm_aix("p12i2","p1i0",[0,"  Visite Dokter  ","","",-1,-1,0,"daftar/daftarinputperawatan.asp?citem=3"]);
stm_aix("p12i3","p1i0",[0,"  Obat  ","","",-1,-1,0,"daftar/daftarinputperawatan.asp?citem=4"]);
stm_aix("p12i4","p1i0",[0,"  Asuhan Kebidanan Pasien  ","","",-1,-1,0,"daftar/daftarinputperawatan.asp?citem=5"]);
stm_aix("p12i5","p1i0",[0,"  Pembayaran  ","","",-1,-1,0,"daftar/daftarinputperawatan.asp?citem=6"]);
stm_ep();
stm_ep();
stm_aix("p0i2","p0i1",[0,"  Menu Laporan  "]);
stm_bpx("p13","p2",[1,4]);
stm_aix("p13i0","p1i0",[0,"  Laporan Kunjungan Per Pasien  ","","",-1,-1,0,"laporan/laporankunjunganperpasien.asp"]);
stm_aix("p13i1","p1i0",[0,"  Laporan Pendapatan Per Pasien  ","","",-1,-1,0,"laporan/laporanpendapatan.asp"]);
stm_aix("p13i2","p1i0",[0,"  Laporan Pembayaran Per Pasien  ","","",-1,-1,0,"laporan/laporanpembayaran.asp"]);
stm_aix("p13i3","p1i0",[0,"  Laporan Pasien yang Belum Lunas  ","","",-1,-1,0,"laporan/laporanhutangpasien.asp"]);
stm_aix("p13i4","p1i0",[0,"  Laporan 10 Besar Penyakit   ","","",-1,-1,0,"laporan/laporan10besarpenyakit.asp"]);
stm_aix("p13i5","p1i0",[0,"  Laporan Kesakitan  ","","",-1,-1,0,"laporan/laporankesakitan.asp"]);
stm_aix("p13i6","p1i0",[0,"  Laporan Morbiditas","","",-1,-1,0,"laporan/laporanmorbiditas.asp"]);
stm_aix("p13i7","p1i0",[0,"  Laporan Morbiditas Surveilens","","",-1,-1,0,"laporan/laporanmorbiditassurveilens.asp"]);
stm_ep();
stm_aix("p0i3","p0i1",[0,"  Menu Utility  ","","",-1,-1,0,"","_self","","","icon_10a.gif","icon_10b.gif",7,13,0,"","",0,0]);
stm_aix("p0i4","p0i1",[0,"  Keluar Aplikasi  "]);
stm_bpx("p14","p13",[]);
stm_aix("p14i0","p1i0",[0,"  Keluar Aplikasi","","",-1,-1,0,"exit.asp","_self","","","","",5,0,0,"","",0,0,0,0,1,"#6E8296"]);
stm_ep();
stm_ep();
stm_em();
//-->
