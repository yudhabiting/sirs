							...
							<ul class="slides">
								<li>
									...
									<div class="slide-cnt">
										...
										<div class="box-cnt">
											<p>
    RSU  : memberikan pelayanan kesehatan yang bersifat spesialistis ditiap unit pelayanan sesuai dengan bidang keahlian masing-masing. poli Umum : memberikan pelayanan kesehatan yang bersifat umum sesuai dengan standar pelayanan medis yang ditetapkan.
