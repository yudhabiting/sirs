...
trawatpasien__MMColParam6 = "%"
If (Request.QueryString("cstatuspasien")  <> " ") Then 
  trawatpasien__MMColParam6 = Request.QueryString("cstatuspasien") 
End If
%>
<%
Dim trawatpasien__MMColParam7
trawatpasien__MMColParam7 = "1"
If (Request.QueryString("ctglmasuk1")  <> "") Then 
  trawatpasien__MMColParam7 = Request.QueryString("ctglmasuk1") 
End If
%>
<%
Dim trawatpasien__MMColParam8
trawatpasien__MMColParam8 = "1"
If (Request.QueryString("ctglmasuk2")  <> "") Then 
  trawatpasien__MMColParam8 = Request.QueryString("ctglmasuk2") 
End If
%>
<%
Dim trawatpasien
...
<table width="100%" class="fontku1">
  ...
  <tr>
    ...
    <td align="center">:</td>
    <td><div align="left">
        <input name="ctglmasuk1" type="text" id="ctglmasuk1" value="<%=request.querystring("ctglmasuk1")%>" size="15" />
        Tahun / Bulan / Tanggal </div></td>
  </tr>
  <tr>
    <td><div align="right">Sampai Tanggal </div></td>
    <td align="center">:</td>
    <td><div align="left">
        <input name="ctglmasuk2" type="text" id="ctglmasuk2" value="<%=request.querystring("ctglmasuk2")%>" size="15" />
        Tahun / Bulan / Tanggal </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><select name="cstatuspasien" id="cstatuspasien">
        <option value=" " <%If (Not isNull(request.querystring("cstatuspasien"))) Then If (" " = CStr(request.querystring("cstatuspasien"))) Then Response.Write("selected=""selected""") : Response.Write("")%>>Semua Data</option>
...
<table width="990px" align="center" class="dhtmlxGrid" style="width:*" gridheight="auto" name="grid2" imgpath="../DHTML/DHTMLgrid/dhtmlxGrid/codebase/imgs/" lightnavigation="true">
    <tr bgcolor="#9999FF">
      <td width="30px">No</td>
      ...
      <td width="100px">Orang Tua / Suami</td>
