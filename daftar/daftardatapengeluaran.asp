...
tinputpengeluaran.Source = "SELECT * FROM rspermata.tinputpengeluaran  WHERE  pengeluaran like '%" + Replace(tinputpengeluaran__MMColParam1, "'", "''") + "%'  ORDER BY tgltrans,nourut ASC"
else
tinputpengeluaran.Source = "SELECT * FROM rspermata.tinputpengeluaran  WHERE  pengeluaran like '%" + Replace(tinputpengeluaran__MMColParam1, "'", "''") + "%'  and tgltrans >= '" + Replace(tinputpengeluaran__MMColParam2, "'", "''") + "' and tgltrans <= '" + Replace(tinputpengeluaran__MMColParam3, "'", "''") + "' ORDER BY tgltrans,nourut ASC"
end if
...
<div id="templatemo_container">
  ...
  <div id="templatemo_banner"></div>
    ...
    <div id="templatemo_content">
      ...
      <form action="daftardatapengeluaran1.asp" method="get" name="form1">
<p>&nbsp;</p>
<table width="100%">
			  <script>
		var myCalendar;
...
%>
    <tr>
      ...
      <td align="center"><A HREF="../editdata/editinputpengeluaran.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ctgltrans=" & tinputpengeluaran.Fields.Item("tgltrans").Value & "&cnourut=" & tinputpengeluaran.Fields.Item("nourut").Value%>"><%=(tinputpengeluaran.Fields.Item("nourut").Value)%></A></td>
