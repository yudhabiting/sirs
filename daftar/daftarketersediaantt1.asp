...
<%
Dim tkriteriakelas
Dim tkriteriakelas_cmd
Dim tkriteriakelas_numRows

Set tkriteriakelas_cmd = Server.CreateObject ("ADODB.Command")
tkriteriakelas_cmd.ActiveConnection = MM_datarspermata_STRING
tkriteriakelas_cmd.CommandText = "SELECT * FROM rspermata.tkriteriakelas" 
tkriteriakelas_cmd.Prepared = true

Set tkriteriakelas = tkriteriakelas_cmd.Execute
tkriteriakelas_numRows = 0
%>
...
function refreshtable()
{
	...
	$('#dg').datagrid({  
			   url:'../include/transaksiJSON.asp?ctabel=tabel09',
					rownumbers:true,
					singleSelect:true,
					pagination:true,
					showFooter:true,
...
<table align="center" id="dg" class="easyui-datagrid"  style="width:1200px;height:auto" title="Daftar Ketersediaan Tempat Tidur Per Ruangan"  idField="kkelas"    url="../include/transaksiJSON.asp?ctabel=tabel09"   toolbar="#toolbar" 
...
<thead >
<tr>
<th field="jumlahtt1" width="225px" align="center" sortable="true" >Jumlah  Tempat Tidur</th>
<th field="jumlahtt2" width="225px" align="center" sortable="true" >Jumlah Tempat Tidur Terpakai</th>
<th field="jumlahtt3" width="225px" align="center" sortable="true" >Jumlah Tempat Tidur Kosong</th>
</tr>
</thead>
</table>
...
<%
tkriteriakelas.Close()
Set tkriteriakelas = Nothing
%>
