...
If (Request.QueryString("ctglfaktur1")  <> "") Then 
  vtmasukobat__MMColParam4 = Request.QueryString("ctglfaktur1") 
End If
%>
<%
Dim vtmasukobat__MMColParam5
vtmasukobat__MMColParam5 = "1"
If (Request.QueryString("ctglfaktur2")  <> "") Then 
  vtmasukobat__MMColParam5 = Request.QueryString("ctglfaktur2") 
End If
%>
