...
<table align="center" id="dg" class="easyui-datagrid"  style="width:975px;height:auto" title="Daftar Pasien "  idField="notrans"    url="../include/daftartransaksiJSON.asp?cstatuspasien=xxxxx&ctabel=transaksi07"   toolbar="#toolbar" 
...
function linkrawatjalan(value,row){
    ...
    var cnocm = row.nocm;
    var url = '<%=fileku%>&cnotrans='+cnotrans;
