...
<table width="100%" align="center" class="dhtmlxGrid" style="width:*" gridheight="auto" name="grid2" imgpath="../DHTML/DHTMLgrid/dhtmlxGrid/codebase/imgs/" lightnavigation="true">
  <tr bgcolor="#9999FF">
    <td width="70px" align="center">Tgl Jatuh Tempo</td>
    <td width="150px" align="left"> No Faktur</td>
    <td width="70px" align="center">Tgl Faktur</td>
    <td width="100px" align="center">Tgl Terima</td>
...
%>
  <tr>
    <td align="center"><a href="../inputdata/inputobatmasuk1.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "cnotrans=" & vtmasukobat.Fields.Item("notrans").Value %>"><%=(vtmasukobat.Fields.Item("tgljatuhtempo").Value)%></a></td>
