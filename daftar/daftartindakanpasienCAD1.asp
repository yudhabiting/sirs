...
<title>Daftar Laborat Pasien</title>
...
<th field="notranstindakan" width="120px" align="center" sortable="true">Notrans Tindakan</th>
...
function linkrawatjalan(value,row){
	...
	if (ckgoltindakan == '05') {
	    var url = '../editdata/editlaboratpasien.asp?cnotrans='+cnotrans+'&cnotranstindakan='+cnotranstindakan+'&cnourut='+cnourut+'&ckgoltindakan='+ckgoltindakan+'&citem=<%=citem%>';
