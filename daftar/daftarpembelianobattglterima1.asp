...
If (Request.QueryString("ctglterima1")  <> "") Then 
  vtmasukobat__MMColParam4 = Request.QueryString("ctglterima1") 
End If
%>
<%
Dim vtmasukobat__MMColParam5
vtmasukobat__MMColParam5 = "1"
If (Request.QueryString("ctglterima2")  <> "") Then 
  vtmasukobat__MMColParam5 = Request.QueryString("ctglterima2") 
End If
%>
...
vtmasukobat.Source = "SELECT * FROM rspermata.vtmasukobat  WHERE nofaktur like '%" + Replace(vtmasukobat__MMColParam1, "'", "''") + "%' and ksuplier like '%" + Replace(vtmasukobat__MMColParam2, "'", "''") + "%' and lunas like '%" + Replace(vtmasukobat__MMColParam3, "'", "''") + "%' ORDER BY tglterima,suplier ASC"
else
vtmasukobat.Source = "SELECT * FROM rspermata.vtmasukobat  WHERE nofaktur like '%" + Replace(vtmasukobat__MMColParam1, "'", "''") + "%' and ksuplier like '%" + Replace(vtmasukobat__MMColParam2, "'", "''") + "%' and lunas like '%" + Replace(vtmasukobat__MMColParam3, "'", "''") + "%' and tglterima >= '" + Replace(vtmasukobat__MMColParam4, "'", "''") + "' and tglterima <= '" + Replace(vtmasukobat__MMColParam5, "'", "''") + "' ORDER BY tglterima,suplier ASC"
end if
...
<title>Daftar Pembelian Obat Berdasarkan Tgl Terima</title>
...
<div id="templatemo_container">
  ...
  <div id="templatemo_banner"></div>
    ...
    <div id="templatemo_content">
      ...
      <form action="daftarpembelianobattglterima1.asp" method="get" name="form1">
<p>&nbsp;</p>
<table width="100%">
		  <script>
		var myCalendar;
		function doOnLoad() {
			myCalendar = new dhtmlXCalendarObject(["ctglterima1","ctglterima2"]);
		}
	</script>

  <tr>
    <td><div align="right"><span class="style11"><font size="2" face="Lucida Sans">Dari Tanggal </font></span></div></td>
    <td align="center">:</td>
    <td><div align="left">
        <input name="ctglterima1" type="text" id="ctglterima1" value="<%=request.querystring("ctglterima1")%>" size="15" />
  ...
  <tr>
    ...
    <td align="center">:</td>
    <td><div align="left">
      <input name="ctglterima2" type="text" id="ctglterima2" value="<%=request.querystring("ctglterima2")%>" size="15" />
      <span class="style11">Tahun / Bulan / Tanggal </span></div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td width="12%"><div align="right"><font size="2" face="Lucida Sans">No Faktur</font></div></td>
