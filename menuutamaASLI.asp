...
stm_aix("p1i0","p0i0",[0,"  Identitas Rumah Sakit / Klinik","","",-1,-1,0,"editdata/editrs.asp","_self","","","","",5,0,0,"","",0,0,0,0,1,"#006633",0,"#CCCCCC",1,"","fade.gif",3,3,0,0,"#7A8C9E","#CCCC00","#FFFFFF","#FFFFFF","12pt Verdana","12pt Verdana"]);
...
stm_bpx("p4","p1",[]);
stm_aix("p4i0","p1i0",[0,"  Daftar Tunggu Pasien","","",-1,-1,0,"inputdata/daftartunggu.asp"]);
stm_aix("p4i1","p1i0",[0,"  Daftar Pasien Rawat Jalan / Inap  ","","",-1,-1,0,"daftar/daftarrawatpasien.asp"]);
stm_aix("p4i2","p1i2",[0,"  Laboratorium"]);
stm_aix("p4i3","p1i2",[0,"  Rontgen"]);
stm_aix("p4i4","p1i4",[0,"  Obat"]);
stm_bpx("p5","p2",[]);
stm_aix("p5i0","p1i0",[0,"  Transaksi Obat Masuk  ","","",-1,-1,0,"inputdata/inputobatmasuk.asp"]);
stm_aix("p5i1","p1i0",[0,"  Transaksi Obat Keluar","","",-1,-1,0,"inputdata/inputobatkeluar.asp"]);
stm_ep();
stm_ep();
